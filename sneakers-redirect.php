...
<head>
    ...
    <body>
                ...
                <div class="sneaker-everything">
                    <div class="sneaker-primary">
                        ...
                        <div class="sneaker-data d2">
                            <a class="action-buttons" href="cart.html"><img src="css/misc/cart.png" class="icon">Add to Cart</a>
                            <a class="action-buttons"><img src="css/misc/purchase.png" class="icon">Purchase</a>
                            <a class="action-buttons" id="rental-button"><img src="css/misc/rent.png" class="icon">Rent</a>
                        </div>
                    </div>
                ...
                <div class="sneaker-review">
                    <div class="sub-div1">
                        <div class="sneaker-quick-details">
                            <div class="sneaker-image review-image" style="background-image:url('<?php echo $finalresults->media->imageUrl ?>');">
                            </div>
        ...
        <div id="rent-container">
            <button onclick="rentalPopup()" id="close-rental-btn">Close</button>
            <div class="sneaker-rent">
                <div class="sneaker-quick-details-rent">
                    <div class="sneaker-image review-image" style="background-image:url('<?php echo $finalresults->media->imageUrl ?>');">
                    </div>
                    <div class="sneaker-brand">
                    <h1><?php echo $finalresults->brand ?></h1>
                ...
                <form action="reviews.php?id=".$id method="post">
                    <div class="rent-sub-div1">
                        <div class="slider">
                            <h3 class="slider-title">Rental Duration</h3>
                            <div class="sub-div1-2">
                                <input type="range" min="1" max="5" value="0" id="range-slider" name="rentalduration">
                                <h3 id="day-count"></h3>
                            </div>
                        </div>
                        <div id="proceed-buttons">
                            <a class="action-buttons" onclick="" id="rental-button"><img src="css/misc/rent.png" class="icon">Rent</a>
                            <a class="action-buttons" href="cart.html"><img src="css/misc/cart.png" class="icon">Add to basket</a>
                        </div>
                    </div>
                </form>
            </div>
